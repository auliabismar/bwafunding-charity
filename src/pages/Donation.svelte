          ...
          <div class="xs-donation-form-wraper">
            ...
            <form
              ...
              <div class="xs-input-group">
                ...
                <input type="text" class="form-control" name="name" id="xs-donate_name" placeholder="Aulia">
              </div>

              <div class="xs-input-group">
                <label for="xs-donate-email">Alamat email <span class="color-light-red">**</span></label>
                <input type="email" name="email" id="xs-donate-email" class="form-control" placeholder="aulia@kataba.id" />
              </div>

              <div class="xs-input-group" id="xs-input-checkbox">
                <input type="checkbox" name="agree" id="xs-donate-agree" />
                <label for="xs-donate-agree">Saya setuju <span class="color-light-red">**</span></label>
              </div>
              <!-- .xs-input-group END -->
